...
class cottonViewController: UIViewController {

    @IBOutlet weak var cottonScrollView: UIScrollView!

    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
        
        // scroll reset
        cottonScrollView.setContentOffset(CGPoint.zero, animated: true)
