...
class surgicalViewController: UIViewController {

    @IBOutlet weak var surgicalScrollView: UIScrollView!
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(animated)
        
        // scroll reset
        surgicalScrollView.setContentOffset(CGPoint.zero, animated: true)
